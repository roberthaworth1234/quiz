...
import FilmAnswers from "./FilmAnswers"

export default class FilmAndTv extends Component {
                 state = {
                   toggled: false,
                   questionNumber: 0,
                   ...
                   if (this.state.answersToggled) {
                      return (
                        <FilmAnswers
                          ...
                          storedFilmAnswers={this.props.storedFilmAnswers}
                     ...
                     return (
                       <div className="rounds">
                         <img
                           className="image"
                           alt="film reel"
                           src={require("../Images/filmreel.png")}
                         ></img>
                        Film & TV
                         <button
                           className="btn"
                     ...
                     return (
                       ...
                       >
                         <div className="game-screen">
                           <h2 className="game-title">Film & TV</h2>
                           {question.map((item, i) => {
                             return (
                               <Animated
                                 id="game-card"
                 ...
                 handleAnimation(guess) {
                   ...
                   if (
                     questionNumber !== 10 &&
                     answers[this.state.questionNumber] !== guess
                   ) {
                     return this.setState({ notCorrect: true, visible: false });
                   } else
                     return this.setState({ isCorrect: true, visible: false });
                 }
                 handleAnswer(guess) {
                   this.props.storeAnswers(guess, "Film");
